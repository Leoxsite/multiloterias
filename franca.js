...
document.addEventListener('DOMContentLoaded', function() {
  ...
  switch (idJogo) {
    ...
    case 'euromillions-my-million':
    await sortearNumeros(idJogo, 5, 50, 2, 12); // ✅ 5 números (1–50) + 2 estrelas (1–12)
    break;

  case 'loto':
    await sortearNumeros(idJogo, 5, 49, 1, 10); // ✅ 5 números (1–49) + 1 número da sorte (1–10)
    break;

  case 'eurodreams-fr':
    await sortearNumeros(idJogo, 6, 40, 1, 5); // ✅ 6 números (1–40) + 1 número "Sonho" (1–5)
    break;

  case 'keno-fr':
    await sortearNumeros(idJogo, 10, 70); // ✅ 10 números (1–70) — estilo Keno
    break;

  case 'joker-plus':
    await sortearNumeros(idJogo, 7, 9); // ✅ 7 dígitos de 0–9 — sequência aleatória
    break;
